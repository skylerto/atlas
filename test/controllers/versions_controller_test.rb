...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { name: @version.name, service_id: @version.service_id } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { name: @version.name, service_id: @version.service_id } }
