...
class DeploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deployment" do
    assert_difference('Deployment.count') do
      post deployments_url, params: { deployment: { environment_id: @deployment.environment_id, name: @deployment.name } }
    end
  ...
  test "should update deployment" do
    patch deployment_url(@deployment), params: { deployment: { environment_id: @deployment.environment_id, name: @deployment.name } }
